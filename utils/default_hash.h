...
#define HASHFCT qf::hash::crc_hash
namespace qf{
...
#define HASHFCT qf::hash::murmur2_hash
namespace qf{
...
#define HASHFCT qf::hash::murmur3_hash
namespace qf{
...
#define HASHFCT qf::hash::xx_hash
namespace qf{
    using default_hash = qf::hash::xx_hash;
}
#endif // XXHASH
