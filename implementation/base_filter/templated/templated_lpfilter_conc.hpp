...
public:
    ...
    static constexpr size_t remainder_bits = remainder_bits_qf+3;
...
public:
	...
	templated_lpfilter_conc& operator=(templated_lpfilter_conc&& other) = default;
