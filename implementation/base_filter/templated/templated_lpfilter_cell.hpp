...
struct templated_lpfilter_cell_base
{
  ...
  public:
    ...
    bool is_empty(size_t pos) const { return remainder(pos) == 0; }
    ...
    // misc
    size_t shift_amount(size_t pos) const { return pos * remainder_bits; }
    ...
    static constexpr size_t capacity =
        sizeof(cell_base_type) * 8u / remainder_bits;
    ...
    : public templated_lpfilter_cell_base<cell_type, remainder_bits>
{
    ...
    templated_lpfilter_cell_non_atomic&
    operator=(const templated_lpfilter_cell_non_atomic&) = default;
...
template <class cell_type, size_t remainder_bits>
struct templated_lpfilter_cell_atomic
    : templated_lpfilter_cell_base<std::atomic<cell_type>, remainder_bits,
                                   cell_type>
{
    using non_atomic =
        templated_lpfilter_cell_non_atomic<cell_type, remainder_bits>;
    using base = templated_lpfilter_cell_base<std::atomic<cell_type>,
                                              remainder_bits, cell_type>;
    ...
    templated_lpfilter_cell_atomic(const non_atomic& other) : base(other.cell)
    {
    }

    templated_lpfilter_cell_atomic&
    operator=(const templated_lpfilter_cell_atomic& other)
    {
