#pragma once
/*******************************************************************************
 * implementation/base_filter/nongrouped/nongrouped_lpfilter_conc.hpp
 *
 * concurrent linear probing filter with non-grouped slots (one slot per atomic)
 *
...
class nongrouped_lpfilter_conc
{
  ...
  public:
    nongrouped_lpfilter_conc(
        ...
        : hf(hf), remainder_bits(remainder_bits + 3),
    ...
    nongrouped_lpfilter_conc(const nongrouped_lpfilter_conc& other)
        : table_capacity(other.table_capacity),
          ...
          quotient_bits(other.quotient_bits), modulo_mask(other.modulo_mask)
    {
