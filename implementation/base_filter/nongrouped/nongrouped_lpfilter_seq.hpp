...
class nongrouped_lpfilter_seq
{
  ...
  private:
    ...
    bool is_empty(size_t pos) const { return table[pos] == 0; }
  ...
  public:
    ...
    {
        auto [q, r] = qf::get_quotient_and_remainder<entry_type>(
