#pragma once
/*******************************************************************************
 * implementation/base_filter/standard/standard_lpfilter_seq.hpp
 *
 * sequential linear probing filter with grouped slots
...
template <class Key, class Hash = htm::default_hash> class standard_lpfilter_seq
{
  public:
