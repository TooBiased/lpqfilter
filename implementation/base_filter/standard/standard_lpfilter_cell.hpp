#pragma once
/*******************************************************************************
 * implementation/base_filter/standard/standard_lpfilter_cell.hpp
 *
 * grouped slot implementation for the linear probing filter
 * (grouped non-templated)
 *
...
template <class cell_base_type> class lp_cell_stuff
{
  public:
    ...
    lp_cell_stuff(size_t remainder)
        : capacity(base_type_bits / remainder), remainder_bits(remainder),
...
template <class cell_type> struct standard_lpfilter_cell_atomic;
    ...
    : public standard_lpfilter_cell_base<cell_type>
{
    ...
    standard_lpfilter_cell_non_atomic&
    operator=(const standard_lpfilter_cell_non_atomic&) = default;
    ...
    inline void
    set_remainder(const cstuff& cc, entry_type remainder, size_t pos)
    {
    ...
    : standard_lpfilter_cell_base<std::atomic<cell_type>, cell_type>
{
    ...
    inline standard_lpfilter_cell_atomic&
    operator=(const standard_lpfilter_cell_atomic& other)
    {
    ...
    inline operator non_atomic() { return {this->cell.load()}; }
